...
namespace jsonrpc {
    namespace json {
		...
		//TODO: replace with json_pointer from document root and use a parsed json for msg type detection
		const char METHOD_PROPERTY[] = "\"method\"";
		const char PARAMS_PROPERTY[] = "\"params\"";
		const char RESULT_PROPERTY[] = "\"result\"";
		const char ERROR_PROPERTY[] = "\"error\"";
